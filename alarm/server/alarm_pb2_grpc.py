...
from server import alarm_pb2 as server_dot_alarm__pb2
...
class AlarmStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteAlarm = channel.unary_unary(
                ...
                request_serializer=server_dot_alarm__pb2.Alarm.SerializeToString,
                response_deserializer=server_dot_alarm__pb2.ActionResponse.FromString,
                )
        ...
        self.ListAlarms = channel.unary_stream(
                ...
                request_serializer=server_dot_alarm__pb2.ListAlarmsParams.SerializeToString,
                response_deserializer=server_dot_alarm__pb2.ActionResponse.FromString,
                )
...
def add_AlarmStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DeleteAlarm': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=server_dot_alarm__pb2.Alarm.FromString,
                    response_serializer=server_dot_alarm__pb2.ActionResponse.SerializeToString,
            ),
            ...
            'ListAlarms': grpc.unary_stream_rpc_method_handler(
                    servicer.ListAlarms,
                    request_deserializer=server_dot_alarm__pb2.ListAlarmsParams.FromString,
                    response_serializer=server_dot_alarm__pb2.ActionResponse.SerializeToString,
            ),
...
class AlarmStore(object):
    ...
    def DeleteAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/alarm.AlarmStore/DeleteAlarm',
            server_dot_alarm__pb2.Alarm.SerializeToString,
            server_dot_alarm__pb2.ActionResponse.FromString,
    ...
    def ListAlarms(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/alarm.AlarmStore/ListAlarms',
            server_dot_alarm__pb2.ListAlarmsParams.SerializeToString,
            server_dot_alarm__pb2.ActionResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
